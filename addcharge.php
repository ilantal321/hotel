...
<html lang="en">
  ...
  <body>
    ...
    <div class="form-group">
        <label class="text-white d-none d-lg-block" for="ocharge">Charge</label>
        <label class="text-white d-none d-lg-block" value="<?php echo $row['charge'];?>" name="ocharge" id="ocharge"><?php echo $row['charge'];?></label>
        <input type="text" class="form-control" name="echarge" id="echarge" placeholder="enter charge to add Put '-' to sub charge">
    </div> 
    <input type="hidden" value="<?php echo $row['pkid'];?>" class="form-control" name="pkid" id="pkid" placeholder="pkid...">
    <input type="hidden" value="<?php echo $row['charge'];?>" class="form-control" name="charge" id="charge" placeholder="charge...">

    <button type="submit" class="btn btn-primary center">Add Charge </button>
</form>
</div>
    <br>

...
<html lang="en">
  ...
  <head>
    ...
    <title>I.T hotel- guests out</title>
  ...
  <body>
    ...
    <div class="container-fluid">
                <h1 class="site-heading text-center text-white d-none d-lg-block">
                    <span class="site-heading-upper text-primary mb-3">Guests Out</span>
                    <span class="massage"><?php echo $_SESSION["massagecout"] ;?></span>
                    <span class="massage"><?php echo $_SESSION["massageaddg"] ;?></span>
                </h1>
            <table class="table tac">
                ...
                //נציג את כל הסטודנטים הקיימים במכללה בתוך טבלה, בעזרת while loop
                    ...
                    while($row = $result->fetch_array()){
                        ...
                        echo "<td>
                        <a href='cin.php?id=$guest->pkid'><img width='30' src='img/cin.jpg'></a>
                        </td>";
                        echo "<td>
                        <a href='' onclick='deleteg($guest->pkid);'><img width='30' src='img/delete.png'></a>
                     </td>";
                        echo "</tr>";
            ...
            <a href="addguest.php" class="btn btn-primary center">Add New Guest</a>
            <br>
    </div>
